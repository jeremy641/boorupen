...
<html lang="zh-Hant-TW">
  ...
  <a href="javascript:void(0);" class="icon" onclick="myFunction()">&#9776;</a>
    ...
    <a href="index_login.html"><input type="submit" value="繼續選購" class="btn" style="position:relative;width:45%; left:0px;"></a>
    <a href="checkout_login.jsp"><input type="submit" value="進行結帳" class="btn" style="position:relative;width:45%;top:-65px; left:800px;background-color:red;"></a>
  </div>
</div>
            </section>
