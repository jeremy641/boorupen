...
if(session.getAttribute("id")!=null){
	if(request.getParameter("id") != null){
		sql = "UPDATE idpass SET id ='" + request.getParameter("id")+"' WHERE id ='"+session.getAttribute("id")+"'";
		con.createStatement().execute(sql);
		sql = "UPDATE idpass SET pwd ='" + request.getParameter("pwd")+"' WHERE id ='"+session.getAttribute("id")+"'";
